...
const ManageDocuments = () => {
  ...
  const [activeTab, setActiveTab] = useState("available/services"); // "request" or "available"
    ...
    <div className="w-full min-h-screen">
      ...
      <div className="w-full flex">
        <div className="flex flex-col">
          <span className="text-3xl font-extrabold">Service Management</span>
      ...
      >
        ...
        <div className="border flex flex-col border-slate-700 bg-slate-800 p-5 rounded-md w-full mt-5">
          ...
          <TabsContent value="available/services">
            <div className="flex flex-col bg-slate-800 px-2 rounded-md w-full mt-3">
              <span className="text-2xl font-extrabold">Barangay Services</span>
              <span className="text-slate-500 mb-5">
                manage available service and their details
              </span>
